...
import yearFixtures from './fixtures/year';
import leagueFixtures from './fixtures/league';
import teamFixtures from './fixtures/team';
import playerFixtures from './fixtures/player';
import bracketFixtures from './fixtures/bracket';
    ...
    routes() {
      ...
      this.get('/teams', (schema, request) => {
        ...
        if (queryParams.rosterId) {
          teams = teams.filter(
            (team) => team.rosterId === queryParams.rosterId
          );
        }
